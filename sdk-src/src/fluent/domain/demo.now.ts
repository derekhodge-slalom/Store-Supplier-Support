...
export const demoSupplierA = Record({ $id: Now.ID['demo_supplier_a'], table: 'customer_account', $meta: demo, data: { name: 'Demo Coffeehouse Packaging Co - CSM Account', active: true } })
export const demoSupplierB = Record({ $id: Now.ID['demo_supplier_b'], table: 'customer_account', $meta: demo, data: { name: 'Demo Beverage Ingredients Co - CSM Account', active: true } })
export const demoSupplierC = Record({ $id: Now.ID['demo_supplier_c'], table: 'customer_account', $meta: demo, data: { name: 'Demo Sanitation & Safety Co - CSM Account', active: true } })
export const demoSupplierD = Record({ $id: Now.ID['demo_supplier_d'], table: 'customer_account', $meta: demo, data: { name: 'Demo Retail Operations Supply Co - CSM Account', active: true } })
