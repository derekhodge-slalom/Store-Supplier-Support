...
Record({ $id: Now.ID['module_consumables'], table: 'sys_app_module', data: { title: 'Store Supply Inventory', application: storeSupplierSupportMenu, link_type: 'LIST', name: 'alm_consumable', query: 'model.sys_class_name=x_sln_store_suppli_store_supply_model', roles: internalNavigationRoles, active: true, order: 340 } })
