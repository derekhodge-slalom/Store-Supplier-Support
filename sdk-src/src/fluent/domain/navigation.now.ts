...
Record({ $id: Now.ID['module_consumables'], table: 'sys_app_module', data: { title: 'Consumable Inventory', application: storeSupplierSupportMenu, link_type: 'LIST', name: 'alm_consumable', query: '', roles: internalNavigationRoles, active: true, order: 330 } })
